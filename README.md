...
**Headline finding:** Just **9%** of active UK research-peptide sellers (32 of 374 audited) publish their own verifiable independent lab certificate. The other 91% show none, a borrowed one, a self-made one, or one that cannot be verified. (518 domains audited in total, including sites now dead or off-scope.)
