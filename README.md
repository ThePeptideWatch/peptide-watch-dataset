...
**Headline finding:** Just **7%** of active UK research-peptide sellers (26 of 391 audited) publish their own verifiable independent lab certificate. The other 93% show none, a borrowed one, a self-made one, or one that cannot be verified. (536 domains audited in total, including sites now dead or off-scope.)
