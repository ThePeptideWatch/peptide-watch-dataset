...
**Headline finding:** Just **6%** of active UK research-peptide sellers (26 of 402 audited) publish their own verifiable independent lab certificate. The other 94% show none, a borrowed one, a self-made one, or one that cannot be verified. (549 domains audited in total, including sites now dead or off-scope.)
