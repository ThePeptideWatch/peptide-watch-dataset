...
**Headline finding:** Just **8%** of active UK research-peptide sellers (30 of 372 audited) publish their own verifiable independent lab certificate. The other 92% show none, a borrowed one, a self-made one, or one that cannot be verified. (516 domains audited in total, including sites now dead or off-scope.)
